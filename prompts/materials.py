# baseline no data
SYSTEM_MATERIAL = """
You are tasked with finding properties for a given crystal formula.
You are not explicitly provided the space group or structure, but may include a guess as part of your explanation.
"""
